...
public class Spawner : MonoBehaviour
{
    ...
    public float nextSpawnTime;     //동전 생성 시간
    void Start()
    {
        SetNextSpawnTime();
    }
    ...
    void SpawnObject()
    {
        ...
        {
            Instantiate(coinPrefabs, spawnTransform.position, spawnTransform.rotation);     //코인 프리팹을 해당 위치에 생성
        }
        else
        {
            Instantiate(MissilePrefabs, spawnTransform.position, spawnTransform.rotation); //미사일 프리팹을 해당 위치에 생성
        }
